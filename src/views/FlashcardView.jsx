...
export default function FlashcardView({ theme, isDark, concepts, progress, setProgress, sounds, awardXP }) {
    ...
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'transparent', padding: SPACING.xl + 'px', textAlign: 'center' }}>
        ...
        <button onClick={() => { setIsComplete(false); setCurrentIndex(0); setIsFlipped(false); }}
          style={{ padding: SPACING.md + 'px ' + 28 + 'px', borderRadius: RADIUS.xl, border: 'none', background: 'linear-gradient(135deg, #0F766E, #0D9488)', color: t.textOnPrimary, fontSize: FONT_SIZE.md, fontWeight: FONT_WEIGHT.semibold, cursor: 'pointer' }}>
  ...
  if (!currentConcept) {
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: SPACING.xl + 'px', textAlign: 'center' }}>
        ...
        <button onClick={() => { setCardFilter('all'); }}
          style={{ padding: SPACING.md + 'px ' + SPACING.xl + 'px', borderRadius: RADIUS.xl, border: 'none', background: 'linear-gradient(135deg, #0F766E, #0D9488)', color: '#fff', fontSize: FONT_SIZE.md, fontWeight: FONT_WEIGHT.bold, cursor: 'pointer' }}>
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'transparent' }}>
      ...
      {/* Card */}
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px ' + SPACING.lg + 'px' }}
        ...
        <div
          ...
          style={{
            width: '100%', maxWidth: 400, minHeight: 280,
